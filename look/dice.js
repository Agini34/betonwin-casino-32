...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-ddb984a6');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-ddb984a6');}
...
function clearFlash(){dieView.classList.remove('rl-win-ddb984a6');dieView.classList.remove('rl-lose-ddb984a6');if(frameEl){frameEl.classList.remove('rl-win-ddb984a6');frameEl.classList.remove('rl-lose-ddb984a6');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-ddb984a6');if(frameEl){frameEl.classList.add('rl-win-ddb984a6');}}else{dieView.classList.add('rl-lose-ddb984a6');if(frameEl){frameEl.classList.add('rl-lose-ddb984a6');}}
...
var brandEl=document.querySelector('.rl-brand-ddb984a6');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
